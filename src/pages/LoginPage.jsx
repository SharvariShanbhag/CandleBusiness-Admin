...
// import { COLORS } from '../utils/constants'; // Make sure this path is correct: ../utils/constants
...
//    * Delegates the actual login logic and redirection to the AuthContext.
//    */
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     setLoading(true); // Set loading state to true while login is in progress
//     // The 'login' function from AuthContext will handle:
//     // 1. Calling the API
//     // 2. Storing the token
//     // 3. Setting user state
//     // 4. Displaying toasts (success/error)
//     // 5. REDIRECTING based on user role
...
// // --- Inline Styles (as provided by you) ---
// const loginPageStyle = {
//   display: 'flex',
//   justifyContent: 'center',
//   alignItems: 'center',
